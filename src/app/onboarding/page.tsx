...
const Page = () => {
    ...
    return (
        <div className='w-screen h-screen flex mt-24 items-center flex-col'>
            <div className='w-4/5 h-2/5'>
                ...
                <div className='flex justify-center items-center flex-row text-xl pt-3 h-full'>
                    <div className='w-3/4 border-2 border-slate-300 text-center mr-8 h-full rounded-xl flex flex-wrap flex-col justify-center place-items-center hover:border-black hover:cursor-pointer'>
